...
@Pseudo
@Mixin(value = MallardDuckEntity.FindNearestNestGoal.class, remap = false)
public abstract class MallardDuckFindNearestNestGoalMixin {
    @Shadow
    @Final
    private MallardDuckEntity duck;
    ...
    private BlockPos findNearestNest() {
        return NestSearchHelper.findNearestAvailableNest(this.duck);
    }
}
