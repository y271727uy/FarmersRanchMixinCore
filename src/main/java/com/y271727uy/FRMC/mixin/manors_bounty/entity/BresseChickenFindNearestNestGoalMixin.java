...
@Pseudo
@Mixin(value = BresseChickenEntity.FindNearestNestGoal.class, remap = false)
public abstract class BresseChickenFindNearestNestGoalMixin {
    @Shadow
    @Final
    private BresseChickenEntity chicken;
    ...
    private BlockPos findNearestNest() {
        return NestSearchHelper.findNearestAvailableNest(this.chicken);
    }
}
