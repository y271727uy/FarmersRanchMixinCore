package com.y271727uy.FRMC.integration.mooncakedelight;
...
public final class MooncakeDelightCroptopiaIntegration {
    ...
    private MooncakeDelightCroptopiaIntegration() {
    }

    public static void registerListeners(IEventBus modEventBus) {
        modEventBus.addListener(MooncakeDelightCroptopiaIntegration::onBuildCreativeModeTabContents);
    }
