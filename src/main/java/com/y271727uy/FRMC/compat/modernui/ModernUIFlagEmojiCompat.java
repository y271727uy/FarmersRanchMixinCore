package com.y271727uy.FRMC.compat.modernui;
...
public final class ModernUIFlagEmojiCompat {
    ...
    private ModernUIFlagEmojiCompat() {
    }
    ...
    public static InputStream openBundledEmoji(String path) throws IOException {
        ...
        InputStream classpathStream = ModernUIFlagEmojiCompat.class.getClassLoader().getResourceAsStream(resourcePath);
